...
<img width="245" alt="F35" src="https://github.com/SungchulLee/probability/assets/170498248/31e14e6d-7082-4d75-81a4-a5ed84fc671f">
...
실제 점화식의 값 : $F_1=1, F_2=1, F_3=-3, F_4=5, F_5=-7
```
```
특성방정식이 중근을 가지는 수열($n=2, a_1=-2, a_2=-1, F_1=1, F_2=1$)에 10번째 항의 비교
<img width="241" alt="-2 -1 1 1 중근 F10" src="https://github.com/SungchulLee/probability/assets/170498248/9bb46477-ad13-4203-a749-0ae5975fcfa1">
실제 점화식의 값 : $F_6=9, F_7=-11, F_8=13, F_9=-15, F_10=17
```
